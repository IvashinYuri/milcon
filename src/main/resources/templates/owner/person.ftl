...
<div class="grid-x">
    <div class="contaner cell margin-top-1">
        <h4 class="text-center margin-bottom-0 title_decor padding-top-03">Профиль пользователя</h4>
        <h5 class="text-center title_decor padding-bottom-05 margin-bottom-0">редактирование персональных данных</h5>
                ...
                <div class="auto cell">
                    <form onsubmit="return false" id="formPerson" class="form_person">
                        ...
                        <div class="grid-x grid-padding-x">
                            ...
                            <div class="small-8 cell">
                                <input type="text" form="formPerson" id="first_name"
                                       placeholder="Введите имя" value="${person.first_name}">
                            </div>
                        </div>
                        <div class="grid-x grid-padding-x">
                            <div class="small-4 cell">
                            ...
                            <div class="small-8 cell">
                                <input type="text" form="formPerson" id="last_name"
                                       placeholder="Введите фамилию" value="${person.last_name}">
                            </div>
                        </div>
                        <div class="grid-x grid-padding-x">
                            <div class="small-4 cell">
                            ...
                            <div class="small-8 cell">
                                <input type="text" form="formPerson" id="email"
                                       placeholder="Введите Email"  value="${person.email}">
                            </div>
                        </div>
                        <div class="grid-x grid-padding-x">
                            <div class="small-4 cell">
                                <label for="middle-label" class="text-right middle">Новый пароль</label>
                            </div>
                            <div class="small-8 cell">
                                <input type="password" form="formPerson" id="password" placeholder="Введите новый пароль">
                            </div>
                        </div>
                        <div class="grid-x grid-padding-x">
                            <div class="small-4 cell">
                        ...
                        <div class="grid-x grid-padding-x">
                            ...
                            <div class="small-8 cell">
                                <select id="timezone" form="formPerson" value = "${person.timezone}">
                        ...
                        <div style="width: 100%; text-align: center; padding-left: 10rem">
                            <input class="button font-size-1 margin-bottom-05" type="submit" id="buttonSave" onclick="doPersonSave()" value="Сохранить">
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#timezone [value='${person.timezone}']").attr("selected", "selected");
    });
    //------------------------------------------------------------------------------------------------------------------
    function doPersonSave() {
        var message = $('#message');
        message.slideUp(0);
